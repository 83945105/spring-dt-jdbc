...
public final class JurRoleUserModel implements Model<JurRoleUserModel, JurRoleUserModel.Column, JurRoleUserModel.On, JurRoleUserModel.Where, JurRoleUserModel.Sort, JurRoleUserModel.Group> {
    ...
    @Override
    public ColumnModel<JurRoleUserModel, Column, On, Where, Sort, Group> getColumn() {
        return new Column();
    }
    ...
    @Override
    public OnModel<JurRoleUserModel, Column, On, Where, Sort, Group> getOn() {
        return new On();
    }
    ...
    public static final class On extends OnModel<JurRoleUserModel, Column, On, Where, Sort, Group> {
        ...
        public OnBuilder<JurRoleUserModel, Column, On, Where, Sort, Group> primaryKey() {
            return this.onBuilder.handler(JurRoleUserModel.tableName, JurRoleModel.tableAlias, JurRoleUserModel.primaryKeyName);
        }
    ...
    public static final class Group extends GroupModel<JurRoleUserModel, Column, On, Where, Sort, Group> {
        ...
        public Group primaryKey() {
            this.columns.add(JurRoleUserModel.primaryKeyName);
            return this;
        }
         ...
         */
        public Group id() {
            this.columns.add(JurRoleUserModel.id);
            return this;
        }
         ...
         */
        public Group roleId() {
            this.columns.add(JurRoleUserModel.roleId);
            return this;
        }
         ...
         */
        public Group role() {
            this.columns.add(JurRoleUserModel.role);
            return this;
        }
        ...
        public Group roleName() {
            this.columns.add(JurRoleUserModel.roleName);
            return this;
        }
         ...
         */
        public Group userId() {
            this.columns.add(JurRoleUserModel.userId);
            return this;
        }
        ...
        public Group userName() {
            this.columns.add(JurRoleUserModel.userName);
            return this;
        }
         ...
         */
        public Group index() {
            this.columns.add(JurRoleUserModel.index);
            return this;
        }
         ...
         */
        public Group status() {
            this.columns.add(JurRoleUserModel.status);
            return this;
        }
        ...
        public Group createTime() {
            this.columns.add(JurRoleUserModel.createTime);
            return this;
        }
        ...
        public Group updateTime() {
            this.columns.add(JurRoleUserModel.updateTime);
            return this;
        }
        ...
        public Group deleteTime() {
            this.columns.add(JurRoleUserModel.deleteTime);
            return this;
        }
        ...
        public Group createTimeStamp() {
            this.columns.add(JurRoleUserModel.createTimeStamp);
            return this;
        }
        ...
        public Group updateTimeStamp() {
            this.columns.add(JurRoleUserModel.updateTimeStamp);
            return this;
        }
        ...
        public Group deleteTimeStamp() {
            this.columns.add(JurRoleUserModel.deleteTimeStamp);
            return this;
        }
